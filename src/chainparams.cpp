...
{
    const char* pszTimestamp = " 1 December 2020, Collact was created.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1606755600, 12115009, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2c0c9cba80784b8ac3cd2f89703a2a81ed9837ab88ec396f1fe23469c272756d"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0x2c0c9cba80784b8ac3cd2f89703a2a81ed9837ab88ec396f1fe23469c272756d")},
            }
        };

        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 0 2c0c9cba80784b8ac3cd2f89703a2a81ed9837ab88ec396f1fe23469c272756d
            /* nTime    */ 1606755600,
            /* nTxCount */ 0,
            /* dTxRate  */ 0.0
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.BIP34Height = 2; // BIP34 activated on regtest (Used in functional tests)
        consensus.BIP34Hash = uint256("762733a142e540690124a3376d31354f3961f3adc481b27ac3e6ce66c725a4e6");
        ...
        genesis = CreateGenesisBlock(1606755600, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x762733a142e540690124a3376d31354f3961f3adc481b27ac3e6ce66c725a4e6"));
        assert(genesis.hashMerkleRoot == uint256S("0x429a2a05fd94438c5ab32b83e0085718980875389aae96c73e65700607697179"));
        ...
        checkpointData = {
            {
                {2, uint256S("762733a142e540690124a3376d31354f3961f3adc481b27ac3e6ce66c725a4e6")},
            }
        };
